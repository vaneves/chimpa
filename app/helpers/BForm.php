...
class BForm extends Html
{
	 ...
	 */
	public static function input($label, $name, $value = null, $size = 'input-block-level', $attrs = array())
	{
	 ...
	 * @return	string				retorna o HTML do input gerado
	 */
	public static function textarea($label, $name, $value = null, $size = 'input-block-level', $attrs = array())
	{
	 ...
	 * @return	string				retorna o HTML do input gerado
	 */
	public static function password($label, $name, $value = null, $size = 'input-block-level', $attrs = array())
	{
	 ...
	 */
	public static function select($label, $name, $options = array(), $selected = null, $size = 'input-block-level', $attrs = array())
	{
		$op = '';
		if(is_array($options))
		{
